    ...
    items.forEach(element => {
      ...
      <div class="row bord">
        <div class="row media col-12">
          <img class="" src="https://images.unsplash.com/photo-1531853121101-cb94c8ed218d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=700&q=80" class="size-64 mr-3" alt="...">
          <div class="media-body col-12 mr-2">
