...
export class Calendar  {
    constructor(){
        ...
        this.getM = (x) => {
            ...
            const out = this.months[parseInt(this.pin) + 1 > 11 ? (parseInt(this.pin) + 1) - 12 : parseInt(this.pin) + 1];
    ...
    build(x) {
        ...
        this.nextMonth = this.months[parseInt(this.pin) + 1 > 11 ? (parseInt(this.pin) + 1) - 12 : parseInt(this.pin) + 1];
        this.getAllDays = (y,m) => {
            return new Date(y, (m + 1), 0).getDate();
        };
        this.getFirstDay = (y,m) => {
        ...
        this.reload = (x) => {
            ...
            this.pin += x === 0 ? -1: 1;
            console.log("=",this.pin," ",this.getM(4));
