...
export class Calendar  {
    ...
    build() {
        ...
        this.fragment.append(`<b>ZUPA GROCHOWA</b>`);
        this.date = new Date();
        ...
        this.nextMonth = months[parseInt(this.selectedMonth) + 1 > 11 ? (parseInt(this.selectedMonth) + 1) - 12 : parseInt(this.selectedMonth) + 1];
        ...
        // [...Array(getFirstDay(2020,parseInt(this.selectedMonth))).keys()].forEach( () => {
        //     this.fragment.find(".set-one").append(`<li><span class="leer"></span></li>`); 
        // });
        // //console.warn(getFirstDay(2020,parseInt(this.selectedMonth)));
        // [...Array(getAllDays(2020,parseInt(this.selectedMonth))).keys()].forEach(element => {
        //     fragment.find(".set-one").append(`<li>${element+1}</li>`); 
        // });
        // [...Array(getFirstDay(2020,parseInt(this.selectedMonth)+1)).keys()].forEach( () => {
        //     this.fragment.find(".set-two").append(`<li><span class="leer"></span></li>`); 
        //     });
        
        //     [...Array(getAllDays(2020,parseInt(this.selectedMonth)+1)).keys()].forEach(element => {
