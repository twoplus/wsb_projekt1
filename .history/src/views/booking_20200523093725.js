...
export const booking = () => {
  ...
  return servePaths.reDirect("booking").then(items => {
    ...
    fragment.find("#tst").append(`<div class="row alert alert-dark">${myOrderFin.room} ${myOrderFin.start.day} ${myOrderFin.start.month} - ${myOrderFin.end.month}${myOrderFin.end.month}</div>`)
