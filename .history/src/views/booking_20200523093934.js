...
export const booking = () => {
  ...
  return servePaths.reDirect("booking").then(items => {
    ...
    if(items.length != 0){//items.length != 0
      ...
      fragment.find(".addhere").append(`<div class="row m-5"><div class="btn btn-start offset-md-4 col-12 col-md4 btn-primary">Zarezerwuj pobyt</div></div><div id="tst"></div>`);
    ...
    fragment.find("#tst").append(`<div class="row alert alert-dark">${myOrderFin.treatments} </div>`)
