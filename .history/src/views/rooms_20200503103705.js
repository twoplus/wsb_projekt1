...
export const rooms = () => {
  ...
  return servePaths.reDirect("rooms").then(items => {
    ...
    items.forEach(element => {
      ...
      <div class="row bord">
        <div class="row medi col-12">
          <img class="col-12 col-md-4" src="https://images.unsplash.com/photo-1531853121101-cb94c8ed218d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=700&q=80" class="size-64 mr-3" alt="...">
          
          <div class="media-body col-12 col-md-6 mx-2 my-3">
