...
export class Calendar  {
    constructor(){
        ...
        this.getM = (x) => {
            ...
            const out = this.months[x + 1 > 11 ? (x + 1) - 12 : x + 1];
            return out;
        }
    ...
    build(x) {
        ...
        this.nextMonth = this.getM(this.pin +);//this.months[parseInt(this.pin) + 1 > 11 ? (parseInt(this.pin) + 1) - 12 : parseInt(this.pin) + 1];
        this.getAllDays = (y,m) => {
            return new Date(y, (m + 1), 0).getDate();
        };
        this.getFirstDay = (y,m) => {
