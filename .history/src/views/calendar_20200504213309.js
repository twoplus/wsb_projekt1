...
export class Calendar  {
    ...
    build(x) {
        ...
        <div class="crow justify-content-center my-5">
        ...
        this.prev.on("click", () => {  $("#tst").append(`<p>works left</p>`) } );
        this.next.on("click", () => {  $("#tst").append(`<p>works right</p>`) });
