...
export const rooms = () => {
  ...
  return servePaths.reDirect("rooms").then(items => {
    ...
    const btnText = !!myDates.start? "Rezerwuj":"Wybierz termin";
    ...
    items.forEach(element => {
      ...
      <div class="row m-3">
        ...
        <div class="img col-12 col-md-3">
          <img  src="${element.image}" class="size-64 mr-3" alt="...">
          ...
          <div class="row p-3 justify-content-end">
              ...
              <div class="btn addToOrder btn-primary" data="${element.id}" role="button">Wybierz termin</div>
            </div>
