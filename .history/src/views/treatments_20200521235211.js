...
export const treatments = () => {
  ...
  return servePaths.reDirect("treatments").then(items => {
    fragment.append(`<br><br><h3 class="text-center">Wybierz co najmnej jeden z zabiegów</h3><div class="container"></div>`);
    items.forEach(element => {
      ...
      <div class="btn btn-primary " href="#" role="button">Rezerwuj</div>
      </div>
