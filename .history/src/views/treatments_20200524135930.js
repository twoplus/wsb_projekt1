...
export const treatments = () => {
  ...
  return servePaths.reDirect("treatments").then(items => {
    ...
    const trts =  [];
    fragment.append(`<br><br><div class="prz-fixed d-flex justify-content-center">
    <h3 class="text-center row">Zamów jeden z zabiegów </h3>
    <a class="btn row btn-secondary btn-nex text-white">Dalej</a>
    <p class="text-center s-count">Wybranych: ${!!myOrder.treatments?myOrder.treatments.length:0}</p></div>
