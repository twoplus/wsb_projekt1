...
export class Calendar  {
    ...
    build(x) {
        ...
        this.update = (x) => {
            ...
            for (tr of trg ){
                p = tr == ".set-one" ? 0 : 1;
                [...Array(this.getFirstDay(2020,x))).keys()].forEach( () => {
        ...
        this.reload = (x) => {
            ...
            $(".set-two").empty();
            this.pin -= 1;
            [...Array(this.getFirstDay(2020,parseInt(this.pin))).keys()].forEach( () => {
                $(".set-one").append(`<li><span class="leer"></span></li>`); 
            });
            [...Array(this.getAllDays(2020,parseInt(this.pin))).keys()].forEach(element => {
