...
export const booking = () => {
  ...
  return servePaths.reDirect("booking").then(items => {
    ...
    if(!!!myOrderFin){//items.length != 0
      ...
      fragment.find(".addhere").append(`<div class="row m-5 alert d-flex justify-content-between alert alert-info">
      
      ${myOrderFin.start.month} - ${myOrderFin.end.day} ${myOrderFin.end.month}
