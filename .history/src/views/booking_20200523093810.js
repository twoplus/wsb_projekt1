...
export const booking = () => {
  ...
  return servePaths.reDirect("booking").then(items => {
    ...
    fragment.find("#tst").append(`<div class="row alert alert-dark">${myOrderFin.treatment} ${myOrderFin.start.day} ${myOrderFin.start.month} - ${myOrderFin.end.day} ${myOrderFin.end.month}</div>`)
