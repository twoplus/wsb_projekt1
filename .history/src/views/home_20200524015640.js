...
export const home = () => {
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Chcesz wymodelować sylwetkę?</h5>
    ...
    <div class="container pt-5 pb-5">
      <div class="row">
        ...
        <div class="col-sm-12 col-lg-4  stretch">   
            ...
            <p class="p-3">Dzięki wsparciu najnowszych technologii pobudzamy Twoją skórę do regeneracji i modelujemy Twoje ciało. Nasz wykwalifikowany personel korzysta z najlepszego na świecie sprzętu oraz swojego doświadczenia, aby sprawić, że z nami osiągniesz swoje wymarzone cele.  </p>
            </div>
        </div>
