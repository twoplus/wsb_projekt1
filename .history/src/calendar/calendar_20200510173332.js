...
export class Calendar  {
    ...
    build(x) {
        ...
        this.sYear = d.getFullYear();
        this.pin = sMonth;

        this.calfrag = $(new DocumentFragment());
        this.calfrag.append(DoubleCal);
        this.calfrag.find(".my1 span:nth-of-type(1)").first().empty().append(this.getM(sMonth));
        this.calfrag.find(".my1 span:nth-of-type(2)").first().empty().append(this.getY(sMonth,this.sYear));
        this.calfrag.find(".my2 span:nth-of-type(1)").first().empty().append(this.getM(sMonth+1));
        this.calfrag.find(".my2 span:nth-of-type(2)").first().empty().append(this.getY(sMonth+1,this.sYear));
        ...
        [...Array(this.getFirstDay(2020,parseInt(sMonth)+1)).keys()].forEach( () => {
