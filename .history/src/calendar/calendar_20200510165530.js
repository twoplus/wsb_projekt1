        ...
        this.reload = (x) => {
          ...
          for (const tr of trg ){
              ...
              [...Array(this.getFirstDay(2020,(this.pin + p))).keys()].forEach( () => {
                  $(tr).empty().append(`<li><span class="leer"></span></li>`); 
              });
              
              [...Array(this.getAllDays(2020,(this.pin + p))).keys()].forEach(element => {
                  $(tr).empty().append(`<li>${element+1}</li>`); 
              });
              
          }
          this.loadMY(this.pin);
          console.info("works");
          // $(".my1 span:nth-of-type(1)").empty().append(this.getM(this.pin));
          // $(".my1 span:nth-of-type(2)").empty().append(this.getY(this.pin,2020));
          // $(".my2 span:nth-of-type(1)").empty().append(this.getM(this.pin+1));
          // $(".my2 span:nth-of-type(2)").empty().append(this.getY(this.pin+1,2020));
      }
    };
