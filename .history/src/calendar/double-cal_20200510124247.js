...
export const DoubleCal = () => {this.fragment = $(new DocumentFragment());
...
// const ulMid1 = $('<li class="mid my1"></li>');
...
$(doubleCalendar).find('.cal-wrap').append("cal1");
//doubleCalendar.find('.cal-wrap').append(cal2);
