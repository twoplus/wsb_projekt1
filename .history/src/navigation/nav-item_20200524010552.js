  ...
  if(text === "Koszyk") {
    ...
    anchor.on('mouseenter', () => {  
      ...
      if(!$.isEmptyObject(myOrdFin)){
        const roomb = !!myOrdFin.room ? "Pokój na termin "+myOrdFin.start.day+" "+myOrdFin.start.month+"-"+myOrdFin.end.day+" "+myOrdFin.start.month:"";//location.pathname = "/";
        const treats = !!myOrdFin.treatments ? "oraz zabiegi w ilości: "+myOrdFin.treatments.length:"";
